...
$fields = array('client','rhEmail','country','lob','o1','o2','o3','o4','o5','d1','d2','d3','d4','d5','hash');
foreach ($fields as $field) {
	$$field = mysqli_real_escape_string($db, $data[$field]);
}
$qq = "INSERT INTO data (" . implode(',', $fields).") VALUES ('$client','$rhEmail','$country','$lob',$o1,$o2,$o3,$o4,$o5,$d1,$d2,$d3,$d4,$d5,'$hash')";
